...
openai.api_key = "c1689c3d23854ba18b7a1fad31c9b1ad" #Azure API Key
openai.api_base = "https://deku-extremes.openai.azure.com/" #Azure Endpoint URL
openai.api_version = "2024-08-01-preview" #Azrue Version

# Streamlit UI
st.title("AI-Powered Video-Audio Replacer")
...
if uploaded_video is not None:
    ...
    # AWS S3: Upload extracted audio to S3 Bucket
    s3_client = boto3.client('s3')
    bucket_name = "my-aws-bucketz"
    ...
    def get_transcription_result(job_name):
        while True:
            ...
            if status['TranscriptionJob']['TranscriptionJobStatus'] in ['COMPLETED', 'FAILED']:
                break
            st.write("Transcription in process...")
            time.sleep(30)
    ...
    # Correct transcription using Azure OpenAI model
    st.info("Correcting transcription with gpt-35-turbo...")
